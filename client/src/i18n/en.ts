...
const en: Record<string, string> = {
  ...
  "contact.info.matrix.label": "Headquarters — São Paulo",
  "contact.info.matrix.address": "Rua Cláudio Soares, 72 — 8th floor",
  ...
  "contact.info.branch.label": "Brasília Office",
  "contact.info.branch.address": "SCS Quadra 9, Parque Cidade Corporate Building",
  "contact.info.branch.address2": "Tower C — Block C — 10th floor",
  ...
  "footer.location": "São Paulo, SP | Brasília, DF — Brazil",
