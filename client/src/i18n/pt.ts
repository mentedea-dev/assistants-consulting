...
const pt: Record<string, string> = {
  ...
  "service.duediligence.highlight.title": "Precisão na quantificação de riscos atuariais em operações societárias",
  "service.duediligence.highlight.desc": "Em operações de fusões e aquisições, IPOs e reestruturações corporativas, a correta mensuração dos passivos atuariais é determinante para a tomada de decisão. Nossa equipe conduz análises aprofundadas de provisões técnicas, premissas biométricas e financeiras, obrigações previdenciárias e contingências atuariais, entregando relatórios que sustentam negociações com segurança jurídica e técnica.",
  "service.duediligence.highlight.item1": "Quantificação de passivos previdenciários e de saúde em M&A",
  "service.duediligence.highlight.item2": "Análise de premissas atuariais e aderência regulatória",
  "service.duediligence.highlight.item3": "Identificação de contingências ocultas e riscos de cauda",
  "service.duediligence.highlight.item4": "Modelagem de cenários para negociação de preço",
  ...
  "contact.info.matrix.label": "Matriz — São Paulo",
  "contact.info.matrix.address": "Rua Cláudio Soares, 72 — 8º andar",
  "contact.info.matrix.address2": "",
  "contact.info.matrix.city": "Pinheiros — São Paulo, SP 05422-030",
  "contact.info.matrix.phone": "+55 11 3335-3366",
  "contact.info.branch.label": "Escritório Brasília",
  "contact.info.branch.address": "SCS Quadra 9, Ed. Parque Cidade Corporate Building",
  "contact.info.branch.address2": "Torre C — Bloco C — 10º andar",
  "contact.info.branch.city": "Brasília, DF 70308-200",
  "contact.info.branch.phone": "+55 61 3550-4379",
  ...
  "footer.location": "São Paulo, SP | Brasília, DF — Brasil",
